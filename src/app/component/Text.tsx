...
const Text: React.FC<TextProps> = ({ 
  ...
  const getSizeClass = (tag: TextTag, size?: string) => {
    ...
    switch (tag) {
      case 'h1':
        return 'text-3xl md:text-4xl font-bold tracking-tight py-5 text-white';
      case 'h2':
        return 'text-2xl md:text-3xl font-bold tracking-tight text-white';
      case 'h3':
        return 'text-xl md:text-3xl font-semibold text-white';
      case 'h4':
        return 'text-xl md:text-2xl font-semibold text-white';
      case 'h5':
        return 'text-lg md:text-xl font-medium text-white';
      case 'h6':
        return 'text-base md:text-lg font-medium text-white';
      case 'p':
        return 'text-sm leading-relaxed mt-2 text-white';
      case 'span':
